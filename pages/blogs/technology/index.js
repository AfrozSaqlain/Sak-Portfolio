  ...
  return (
    <div className="relative h-full">
      ...
      <SimpleBar forceVisible="y" autoHide={true} className="overflow-visible overscroll-y-auto h-full">
        <div className="relative mx-4 md:mx-24 lg:mx-32 mt-10 md:mt-10 pb-24 lg:mt-5">
          <h1 className="h2 mb-6 text-center">Welcome to <span className='text-accent'>Tech blog!</span></h1>
          <ul className="grid gap-6 grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
          {posts.length > 0 ? (
