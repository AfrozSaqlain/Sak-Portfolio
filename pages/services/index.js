      ...
      <div className="container mx-auto">
        <div className='flex flex-col xl:flex-row gap-x-8'>
          ...
          <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0'>
            ...
            <motion.p variants={fadeIn('up', 0.4)} initial='hidden' animate='show' exit='hidden' className='mb-4 max-w-[400px] mx-auto lg:mx-0'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus officiis excepturi voluptatem provident numquam! Corporis, minus rem! Reprehenderit laborum nemo totam nisi cum aspernatur possimus quia. Assumenda perspiciatis minima sit.</motion.p>
          </div>
            {/* slider */}
